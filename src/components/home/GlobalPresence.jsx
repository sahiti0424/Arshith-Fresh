    ...
    <section style={{ background: 'var(--bg)', padding: '120px 60px', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <motion.div variants={fadeUp} style={{ position: 'relative', width: '100%', height: 500, background: 'var(--surface)', borderRadius: 24, border: '1px solid var(--border)', overflow: 'hidden' }} className="shadow-lg">
          ...
          {/* Stats Overlay */}
          <div className="global-presence-stats" style={{ position: 'absolute', bottom: 30, left: 30, right: 30, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', gap: 20, background: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(12px)', padding: 24, borderRadius: 16, border: '1px solid var(--border)' }}>
            {[
